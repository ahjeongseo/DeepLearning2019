...
class Hparams:
    ...
    parser.add_argument('--logdir', default='./part5/log', help="log directory")
    # DEFINE 5
    parser.add_argument('--num_epochs', default=-1, type=int) 
    parser.add_argument('--evaldir', default='./part5/eval', help="evaluation dir")
    ...
    parser.add_argument('--testdir', default='./part5/test', help="test result dir")
